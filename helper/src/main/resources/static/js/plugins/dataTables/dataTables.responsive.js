...
$.extend( Responsive.prototype, {
	...
	_columnsVisiblity: function ( breakpoint )
	{
		...
		// Second pass, use up any remaining width for code columns. For
		...
		// width first so we know how much width is available for the code
		...
		columns.each( function ( col, i ) {
			...
			for ( var k=0, ken=classNames.length ; k<ken ; k++ ) {
				...
				if ( className === 'all' ) {
					...
					// Special column that is only visible, when one of the code
