...
(function($){
    var Rslide=function(ele,options){
        ...
        this.$dialog = this.$element.find('.rslide-body')
        this.isShown = null
        this.defaults={
            title:"添加信息",
            content:"",
    ...
    Rslide.TRANSITION_DURATION = 400
    Rslide.BACKDROP_TRANSITION_DURATION = 400
...
/*    Rslide.prototype.show = function (_relatedTarget) {
    ...
    Rslide.prototype.show = function (_relatedTarget) {
        ...
        this.$element.on('click.dismiss.bs.rslide', '[data-dismiss="rslide"]', $.proxy(this.hide, this))
            ...
            var transition = $.support.transition && that.$element.hasClass('rslide')
            ...
            var e = $.Event('shown.bs.rslide', { relatedTarget: _relatedTarget });
            transition ?
                that.$element // wait for modal to slide in
                    .one('bsTransitionEnd', function () {
                        that.$element.trigger(e)
                    })
                    .emulateTransitionEnd(Rslide.TRANSITION_DURATION) :
                that.$element.trigger(e)
    ...
    Rslide.prototype.hide = function (e) {
        ...
        setTimeout(function(){
            that.$element.hide()
            that.$element.removeClass("fadeOutRightBig");
